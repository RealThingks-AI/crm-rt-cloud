    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="bg-blue-50 p-4 rounded-lg">
          <h3 className="font-medium text-blue-900 mb-2">Converting Contact to Lead</h3>
          <p className="text-sm text-blue-700">
            All available contact information has been pre-filled below. Review and modify as needed before converting.
          </p>
        </div>
