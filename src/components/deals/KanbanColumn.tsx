...
const KanbanColumn = ({ stage, deals, onRefresh, onEditDeal, onDeleteDeal, selectedDealIds = [], onDealSelection }: KanbanColumnProps) => {
        ...
        >
          {deals.map((deal, index) => (
            <DealCard 
              ...
              onSelect={onDealSelection ? (selected: boolean) => onDealSelection(deal.id, selected) : undefined}
            />
          ))}
          {deals.length === 0 && (
